  ...
  return (
    <div id="" className="testimonia-sec">
      <Fade top>
        <div className="container">
          ...
          <ul class="nav nav-tabs">
            <li class="active">
              <a data-toggle="tab" href="#studenst" className="active">
                Students
              </a>
            </li>
            <li>
      ...
      <div
        ...
        style={{ backgroundImage: `url("/images/testimonial-bg-new.png")` }}
      >
        <div className="container">
        ...
        <div className="container">
          <div className="partner-sponsor-wrap">
            <div className="visual-text text-center mb-30">
              ...
              <Fade bottom>
                <p>
                  It takes a village to create high quality, high impact STEM
                  education and make it accessible to all. We are grateful to
                  our sponsors and partners for helping make it happen.
                </p>
              </Fade>
            </div>
            <ul>
              {partnersLogo.map((item, index) => {
                return (
                  <li className={index >= 5 ? "hide" : "show"}>
                    <img src={item["src"]} />
                  </li>
                );
              })}
