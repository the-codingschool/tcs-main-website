...
function KeyInitiatives() {
    ...
    return (
        <div
            id=""
            className="KeyInitiatives mt-80 pt-80 pb-80 position-relative"
        >
            ...
            <div className="container KeyInitiatives-content">
                <div className="row">
                    ...
                    <div className="col-12">
                        <div className="visual-text text-center mt-20">
                            ...
                            <Fade left>
                                <h4 className="m-auto">
                                    <span className="highlight-text fz-60">
                                        55%
                                    </span>{" "}
                                    of our students are from underrepresented
                                    backgrounds in STEM
                                </h4>
                            </Fade>
                        </div>
