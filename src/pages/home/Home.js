...
const programPost = [
  {
    name: "1",
    title:
      "Quantum Computing: summer camps, research opportunities & internships",
...
const programPostUniversity = [
  {
    name: "1",
    title:
      "Quantum Computing: year-long course, research opportunities, internships",
  ...
  },
  {
    id: "2",
    title:
      "Classical Coding: 1:1 and small group lessons, research opportunities",
...
const programPostEducators = [
  {
    name: "1",
    title:
      "Educators Programs: Professional Development Training in Artificial Intelligence ",
...
const keyPost = [
  {
    name: "1",
    title:
      "codeConnects empowers K-12 students with classical coding skills from Python to specialized tech areas including AI, cybersecurity, big data and more. ",
  ...
  },
  {
    name: "1",
    title:
      "Qubit by Qubit makes quantum computing education accessible to K-12; university, and the workforce through camps, year-long courses, research and internships.",
  ...
  },
  {
    name: "1",
    title:
      "TRAIN is creating the future AI leaders through a first-of-its-kind year-long course: Introduction to  Machine Learning (ML) for High School Students and Educators.",
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <Fade left>
                ...
                <p>
                  To expand the pool of qualified talent and increase diversity
                  in tech, every student needs access to high quality computer
                  science education. We’re making that a reality. Taught by PhD
                  researchers and professional software engineers, our students
                  gain in-depth knowledge and real world skills in emerging
                  technologies, such as AI and Quantum Computing, that they
                  would not otherwise have access to.{" "}
                </p>
                <p>
                  Our model offers virtual courses with live instruction,
                  teaching nearly 10,000 students in a single course with
                  staggeringly impressive outcomes.
                </p>
                <p>
                  Through this model, every student in the U.S. can have access
                  to high-quality computer science instruction.
                </p>
              </Fade>
            </div>
            <div className="col-lg-6 col-md-12">
                  ...
                  <Fade bottom>
                    ...
                    <div className="row home-banner mt-30 p-0">
                      ...
                      <div className="col-md-6 text-left">
                        <HashLink className="btn btn-outline link" to="/about_us#school-partners">
                          {" "}
