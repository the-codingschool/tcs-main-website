              ...
              <div className="col-md-12">
                <div className="headline" data-aos="zoom-in">
                  <a href="https://trains.hailogics.com">
                    <h1>
                      <img src={require("./images/site_logo.png")} />{" "}
                      <span>The Next Generation of</span> AI LEADERS AND
                      EDUCATORS
                    </h1>
                  </a>
                </div>
                ...
                >
                  <h4>
                    This initiative is proudly funded by the Department of
                    Defense National Defense Education Program
                  </h4>
                </div>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-12 col-md-10 mx-auto">
            <div className="train-banner-below">
              ...
              >
                <h6 className="mb-0">
                  “[Artificial Intelligence] will be the most powerful tool in
                  generations for benefiting humanity.”{" "}
                </h6>
                <h6 className="my-0 text-thin">
              ...
              <div className="desc" data-aos="fade-up" data-aos-duration="600">
                <p class="text-dark">
                  ...
                  <span className="text-brand text-bold">
                    That’s why we’re providing in-depth, real-world AI skills
                    and knowledge to thousands of high school students and
                    educators around the United States.
                  </span>
                </p>
              </div>
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                >
                  <h2>
                    ...
                    <span class="bar-overline">
                      <span className="bo-text">PROGRAM</span>
                    </span>{" "}
                  </h2>
                </div>
                <div
                ...
                >
                  <p class="text-dark">
                    In collaboration with USC’s Viterbi School of Engineering,
                    we’re offering two, first-of-its-kind programs for high
                    school students and educators focused on Machine Learning
                    (ML), a subfield of Artificial Intelligence. Main components
                ...
                >
                  ...
                  <div className="desc">
                    <p>
                      ...
                      and educators beginning in September 2022.
                      <br />
                      <div className="row home-banner mt-30 p-0">
                        <div className="col-md-11 text-center">
                          <a
                            className="btn-train btn-train-outline link"
              ...
              <div className="col-md-4">
                ...
                >
                  ...
                  <div className="desc">
                    <p>
                      A four-week professional development (PD) course for high
                      school educators and community college faculty in July
                      2022. <br />{" "}
                      <div className="row home-banner mt-65 p-0">
                        <div
              ...
              <div className="col-md-8">
                ...
                >
                  <p class="text-dark text-bold">
                    To ensure{" "}
                    <span class="highlight-underline-green">accessibility</span>
                    , all programming is virtual, meaning students and educators
                    from anywhere in the United States can participate.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                ...
                >
                  <p>
                    Our goal is to provide every high school student with real
                    world AI skills. Currently, there are not enough qualified
                    high school educators to teach AI in high schools. We’ve
                    partnered with 100+ schools and school districts to bring
                    education in emerging technologies to students around the
                    U.S. and globe. Be one of the first schools to offer
                    students the chance to learn about the exciting world of AI.
                  </p>
                </div>
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                >
                  ...
                  <div className="desc">
                    <p>
                      Nationally accredited by WASC, we offer our two-semester
                      Introduction to ML course for high school credit at
                      participating schools and school districts. We provide the
                      weekly instruction; assignments, including problem sets,
                      homework and projects; and grading and transcripts; all
                      that we require of participating schools is that they
                      approve to offer the course for transcript credit. We work
                      with individual schools, school districts, and statewide
                      DOEs. To learn more about how to offer this course for
                      credit, fill out this form or email{" "}
                      <a
              ...
              <div className="col-md-6">
                ...
                >
                  ...
                  <div className="desc">
                    <p>
                      High school educators and community college faculty have
                      two professional development (PD) opportunities: a 4-week
                      summer intensive or participating in the two-semester
                      Introduction to ML course, in which educators will have a
                      weekly lab section specifically designed for teachers.
                      Educators will develop in-depth ML knowledge, receive
                      curriculum they can integrate into their existing
                      curricula, and join an online community of like-minded
                      educators who are bringing AI into their classrooms.
                      Teachers will receive Continuing Education Units (CEUs)
                      from University of Southern California (USC) and a stipend
                      upon completion of the training and integration of
                      curricula into their classrooms. The first educator cohort
              ...
              <div className="col-md-12">
                ...
                <div>
                  <h4 className="text-center">
                    {" "}
                    We work with leading experts in AI to ensure our students
                    are inspired and receive the most cutting-edge, high quality
                    education possible.{" "}
                  </h4>
                </div>
                <ul>
                  ...
                  <li data-aos="fade-up" data-aos-duration="600">
                    <div className="main">
                      ...
                      <div className="position">
                        <p>
                          Head of AI Research at J.P. Morgan & President AAA
                        </p>
                      </div>
                    </div>
                  </li>
                  <li data-aos="fade-up" data-aos-duration="700">
                    <div className="main">
                      ...
                      <div className="position">
                        <p>
                          Research Professor at Carnegie Mellon University and
                          Chair of AI4K12
                        </p>
                      </div>
                    </div>
                  ...
                  <li data-aos="fade-up" data-aos-duration="900">
                    <div className="main">
                      ...
                      <div className="position">
                        <p>
                          Assistant Professor of Operations Research & Data
                  ...
                  <li data-aos="fade-up" data-aos-duration="1200">
                    <div className="main">
                      ...
                      <div className="position">
                        <p>
                          Director for Strategic AI and Data Science Initiatives
                          & Professor at USC
                        </p>
                      </div>
                    </div>
                  ...
                  <li data-aos="fade-up" data-aos-duration="1300">
                    <div className="main">
                      ...
                      <div className="position">
                        <p>
                          President of CSTA & CS Teacher at Bergen County
                          Academies
                        </p>
                      </div>
                    </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                >
                  <p>
                    {" "}
                    To ensure the most engaging, high quality AI experience, we
                    are proudly partnered with{" "}
                  </p>
                </div>
                <div
                  className="img mb-60"
                ...
                >
                  <p>
                    We are honored that this project is supported by a
                    three-year grant award from the United States Department of
                    Defense’s National Defense Education Program
                  </p>
                </div>
