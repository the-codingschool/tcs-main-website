...
const Train = (props) => {
    ...
    return (
        <>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tagline" data-aos="fade-up" data-aos-duration="500">
                            ...
                            <div class="desc" data-aos="fade-up" data-aos-duration="600">
            ...
            <section class="section_1" id="introduction">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="main" data-aos="fade-left" data-aos-duration="500">
                                ...
                                <div class="desc">
                                    <p>A two-semester, for-credit course for high school students and educators beginning in September 2022.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="main" data-aos="fade-left" data-aos-duration="600">
                                <div class="tagline">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="headline" data-aos="fade-up" data-aos-duration="600">
                            ...
                            {/* <div class="more" data-aos="fade-up" data-aos-duration="800">
                                <a href="#" onclick="myFunction()" id="myBtn">Read More <i class="fa fa-long-arrow-right"></i></a>
